...
<!-- 	    <link rel="canonical" href="https://getbootstrap.com/docs/4.5/examples/product/"> -->
    ...
    <!-- Bootstrap core CSS -->
<!-- <link href="/bootstrap-4.5.0-examples/assets/dist/css/bootstrap.css" rel="stylesheet"> -->
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<a class="navbar-brand" href="/zeus/index.jsp"> <img
			src="/zeus/img/zeus_logo_transparent.png" alt="logo" style="width: 3rem;">
		</a>
...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light aaa">
